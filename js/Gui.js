...
var Gui = ( function () {
    ...
    Gui.basicMenu = function(){
        ...
        gr0.add('list',   { name:'EnvMap',  list:['black', 'brush', 'chrome', 'glow', 'medium', 'metal', 'plastic', 'red', 'skin' ,'sky', 'smooth', 'yellow', 'luma', 'lava'], height:30, value:'yellow'}).onChange( function(v){ switchEnv(v);  } );
