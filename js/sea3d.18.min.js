...
THREE.SEA3D.Object3DAnimator=function(a,b){THREE.SEA3D.Animator.call(this,a);this.object3d=b;this.mixer=new THREE.AnimationMixer(b);this.relative=!1};THREE.SEA3D.Object3DAnimator.prototype=Object.create(THREE.SEA3D.Animator.prototype);THREE.SEA3D.Object3DAnimator.prototype.constructor=THREE.SEA3D.Object3DAnimator;
THREE.SEA3D.Object3DAnimator.prototype.stop=function(){this.currentAnimation&&(THREE.SEA3D.AnimationHandler.removeMixer(this.mixer),this.previousAnimation=this.currentAnimation,delete this.currentAnimation,this.isPlaying=!1)};THREE.SEA3D.Object3DAnimator.prototype.pause=function(){this.isPlaying&&this.currentAnimation&&(THREE.SEA3D.AnimationHandler.removeMixer(this.mixer),this.isPlaying=!1)};
THREE.SEA3D.Object3DAnimator.prototype.resume=function(){!this.isPlaying&&this.currentAnimation&&(THREE.SEA3D.AnimationHandler.addMixer(this.mixer),this.isPlaying=!0)};THREE.SEA3D.Object3DAnimator.prototype.setTimeScale=function(a){this.mixer.timeScale=a};THREE.SEA3D.Object3DAnimator.prototype.getTimeScale=function(){return this.mixer.timeScale};
THREE.SEA3D.Object3DAnimator.prototype.play=function(a,b,c){c=this.animations[a];if(!c)throw Error('Animation "'+a+'" not found.');this.previousAnimation=this.currentAnimation;this.currentAnimation=c;this.isPlaying=!0;this.mixer.clipAction(c).setLoop(c.loop?THREE.LoopRepeat:THREE.LoopOnce,Infinity).reset().play();this.previousAnimation&&this.mixer.clipAction(this.previousAnimation).crossFadeTo(this.mixer.clipAction(this.currentAnimation),b||0,!0);THREE.SEA3D.AnimationHandler.addMixer(this.mixer)};
THREE.SEA3D.Object3DAnimator.prototype.updateAnimations=function(){this.mixer&&THREE.SEA3D.AnimationHandler.removeMixer(this.mixer);this.mixer=new THREE.AnimationMixer(this);this.animations=[];for(var a=this instanceof THREE.SEA3D.Object3DAnimator?this.clips:this.geometry.animations,b=0;b<a.length;b++)this.animations[b]=a[b],this.animations[a[b].name]=a[b]};
THREE.SEA3D.Object3DAnimator.prototype.stop=function(){if(this.currentAnimation){if(this instanceof THREE.SEA3D.Object3DAnimator){var a=this.object3d.animate;a.position=new THREE.Vector3;a.quaternion=new THREE.Quaternion;a.scale=new THREE.Vector3(1,1,1)}THREE.SEA3D.AnimationHandler.removeMixer(this.mixer);this.previousAnimation=this.currentAnimation;delete this.currentAnimation;this.isPlaying=!1}};
THREE.SEA3D.Object3DAnimator.prototype.play=function(a,b,c){c=this.animations[a];if(!c)throw Error('Animation "'+a+'" not found.');this.previousAnimation=this.currentAnimation;this.currentAnimation=c;this.isPlaying=!0;this.mixer.clipAction(c).setLoop(c.loop?THREE.LoopRepeat:THREE.LoopOnce,Infinity).reset().play();this.previousAnimation&&this.mixer.clipAction(this.previousAnimation).crossFadeTo(this.mixer.clipAction(this.currentAnimation),b||0,!0);THREE.SEA3D.AnimationHandler.addMixer(this.mixer)};
...
THREE.SEA3D.SkinnedMesh.prototype.copy=function(a){THREE.SkinnedMesh.prototype.copy.call(this,a);this.props=a.props;this.scripts=a.scripts;this.animation&&(this.animation=a.animation.clone(this));this.geometry.animations&&this.updateAnimations();return this};THREE.SEA3D.VertexAnimationMesh=function(a,b){THREE.Mesh.call(this,a,b);this.type="MorphAnimMesh";this.mixer=new THREE.AnimationMixer(this);this.updateAnimations()};THREE.SEA3D.VertexAnimationMesh.prototype=Object.create(THREE.Mesh.prototype);
THREE.SEA3D.VertexAnimationMesh.prototype.constructor=THREE.SEA3D.VertexAnimationMesh;THREE.SEA3D.VertexAnimationMesh.prototype.setAnimate=THREE.SEA3D.Object3D.prototype.setAnimate;THREE.SEA3D.VertexAnimationMesh.prototype.getAnimate=THREE.SEA3D.Object3D.prototype.getAnimate;THREE.SEA3D.VertexAnimationMesh.prototype.setTimeScale=THREE.SEA3D.Object3DAnimator.prototype.setTimeScale;THREE.SEA3D.VertexAnimationMesh.prototype.getTimeScale=THREE.SEA3D.Object3DAnimator.prototype.getTimeScale;
THREE.SEA3D.VertexAnimationMesh.prototype.play=THREE.SEA3D.Object3DAnimator.prototype.play;THREE.SEA3D.VertexAnimationMesh.prototype.stop=THREE.SEA3D.Object3DAnimator.prototype.stop;THREE.SEA3D.VertexAnimationMesh.prototype.pause=THREE.SEA3D.Object3DAnimator.prototype.pause;THREE.SEA3D.VertexAnimationMesh.prototype.resume=THREE.SEA3D.Object3DAnimator.prototype.resume;THREE.SEA3D.VertexAnimationMesh.prototype.updateAnimations=THREE.SEA3D.Object3DAnimator.prototype.updateAnimations;
THREE.SEA3D.VertexAnimationMesh.prototype.copy=function(a){THREE.Mesh.prototype.copy.call(this,a);this.props=a.props;this.scripts=a.scripts;this.animation&&(this.animation=a.animation.clone(this));return this};THREE.SEA3D.Camera=function(a,b,c,d){THREE.PerspectiveCamera.call(this,a,b,c,d)};THREE.SEA3D.Camera.prototype=Object.create(THREE.PerspectiveCamera.prototype);THREE.SEA3D.Camera.prototype.constructor=THREE.SEA3D.Camera;THREE.SEA3D.Camera.prototype.setAnimate=THREE.SEA3D.Object3D.prototype.setAnimate;
THREE.SEA3D.Camera.prototype.getAnimate=THREE.SEA3D.Object3D.prototype.getAnimate;THREE.SEA3D.Camera.prototype.setTimeScale=THREE.SEA3D.Object3DAnimator.prototype.setTimeScale;THREE.SEA3D.Camera.prototype.getTimeScale=THREE.SEA3D.Object3DAnimator.prototype.getTimeScale;THREE.SEA3D.Camera.prototype.play=THREE.SEA3D.Object3DAnimator.prototype.play;THREE.SEA3D.Camera.prototype.stop=THREE.SEA3D.Object3DAnimator.prototype.stop;THREE.SEA3D.Camera.prototype.pause=THREE.SEA3D.Object3DAnimator.prototype.pause;
THREE.SEA3D.Camera.prototype.resume=THREE.SEA3D.Object3DAnimator.prototype.resume;THREE.SEA3D.Camera.prototype.updateAnimations=THREE.SEA3D.Object3DAnimator.prototype.updateAnimations;THREE.SEA3D.Camera.prototype.copy=function(a){THREE.PerspectiveCamera.prototype.copy.call(this,a);this.props=a.props;this.scripts=a.scripts;this.animation&&(this.animation=a.animation.clone(this));return this};THREE.SEA3D.PointLight=function(a,b,c,d){THREE.PointLight.call(this,a,b,c,d)};
THREE.SEA3D.PointLight.prototype=Object.create(THREE.PointLight.prototype);THREE.SEA3D.PointLight.prototype.constructor=THREE.SEA3D.PointLight;THREE.SEA3D.PointLight.prototype.setAnimate=THREE.SEA3D.Object3D.prototype.setAnimate;THREE.SEA3D.PointLight.prototype.getAnimate=THREE.SEA3D.Object3D.prototype.getAnimate;THREE.SEA3D.PointLight.prototype.setTimeScale=THREE.SEA3D.Object3DAnimator.prototype.setTimeScale;THREE.SEA3D.PointLight.prototype.getTimeScale=THREE.SEA3D.Object3DAnimator.prototype.getTimeScale;
THREE.SEA3D.PointLight.prototype.play=THREE.SEA3D.Object3DAnimator.prototype.play;THREE.SEA3D.PointLight.prototype.stop=THREE.SEA3D.Object3DAnimator.prototype.stop;THREE.SEA3D.PointLight.prototype.pause=THREE.SEA3D.Object3DAnimator.prototype.pause;THREE.SEA3D.PointLight.prototype.resume=THREE.SEA3D.Object3DAnimator.prototype.resume;THREE.SEA3D.PointLight.prototype.updateAnimations=THREE.SEA3D.Object3DAnimator.prototype.updateAnimations;
THREE.SEA3D.PointLight.prototype.copy=function(a){THREE.PointLight.prototype.copy.call(this,a);this.props=a.props;this.scripts=a.scripts;this.animation&&(this.animation=a.animation.clone(this));return this};THREE.SEA3D.AnimationHandler={mixers:[],update:function(a){for(var b=0;b<this.mixers.length;)this.mixers[b++].update(a)},addMixer:function(a){-1===this.mixers.indexOf(a)&&this.mixers.push(a)},removeMixer:function(a){-1!==this.mixers.indexOf(a)&&this.mixers.splice(this.mixers.indexOf(a),1)}};
THREE.SEA3D.SCRIPT=new SEA3D.ScriptManager;THREE.SEA3D.SCRIPT.dispatchUpdate=function(a){this.dispatchEvent({type:"update",delta:a})};THREE.SEA3D.Domain=function(a,b,c){SEA3D.Domain.call(this,a);this.objects=b;this.container=c};THREE.SEA3D.Domain.prototype=Object.create(SEA3D.Domain.prototype);THREE.SEA3D.Domain.prototype.constructor=THREE.SEA3D.Domain;THREE.SEA3D.Domain.prototype.runScripts=function(){for(var a=0;a<this.scriptTargets.length;a++)this.runJSMList(this.scriptTargets[a])};
THREE.SEA3D.Domain.prototype.runJSMList=function(a){for(var b=a.scripts,c=0;c<b.length;c++)this.runJSM(a,b[c]);return b};
...
THREE.SEA3D.prototype.readAnimation=function(a){for(var b=[],c=1E3/a.frameRate/1E3,d=0;d<a.sequence.length;d++)for(var e=a.sequence[d],f=[],h=0;h<a.dataList.length;h++){var g=a.dataList[h],k,l,m,q=g.data;l=e.start*g.blockSize;k=l+e.count*g.blockSize;var r=e.intrpl?THREE.InterpolateLinear:!1,s=null;switch(g.kind){case SEA3D.Animation.POSITION:s=".position";break;case SEA3D.Animation.ROTATION:s=".quaternion";break;case SEA3D.Animation.SCALE:s=".scale";break;case SEA3D.Animation.COLOR:s=".color";break;
case SEA3D.Animation.MULTIPLIER:s=".intensity";break;case SEA3D.Animation.FOV:s=".fov"}if(s){switch(g.type){case SEA3D.Stream.BYTE:case SEA3D.Stream.UBYTE:case SEA3D.Stream.INT:case SEA3D.Stream.UINT:case SEA3D.Stream.FLOAT:case SEA3D.Stream.DOUBLE:case SEA3D.Stream.DECIMAL:l=q.slice(l,k);k=new Float32Array(l.length);for(m=g=0;m<k.length;m++)k[m]=g,g+=c;f.push(new THREE.VectorKeyframeTrack(s,k,l,r));break;case SEA3D.Stream.VECTOR3D:l=q.slice(l,k);k=new Float32Array(l.length/g.blockSize);for(m=g=0;m<
k.length;m++)k[m]=g,g+=c;f.push(new THREE.VectorKeyframeTrack(s,k,l,r));break;case SEA3D.Stream.VECTOR4D:l=q.slice(l,k);k=new Float32Array(l.length/g.blockSize);for(m=g=0;m<k.length;m++)k[m]=g,g+=c;f.push(new THREE.QuaternionKeyframeTrack(s,k,l,r));break;case SEA3D.Stream.INT24:case SEA3D.Stream.UINT24:l=new Float32Array(3*(k-l));k=new Float32Array(l.length/3);for(m=g=0;m<k.length;m++)l[3*m]=(q[m]>>16&255)/255,l[3*m+1]=(q[m]>>8&255)/255,l[3*m+2]=(q[m]&255)/255,k[m]=g,g+=c;f.push(new THREE.VectorKeyframeTrack(s,
k,l,r))}q=new THREE.AnimationClip(e.name,-1,f);q.loop=e.repeat;b.push(q)}}this.domain.animationClips=this.animationClips=this.animationClips||[];this.animationClips.push(this.objects[a.name+".#anm"]=a.tag=b)};
...
THREE.SEA3D.prototype.readMaterial=function(a){var b=this.createMaterial(a);b.name=a.name;b.side=a.bothSides?THREE.DoubleSide:THREE.FrontSide;b.shading=a.smooth?THREE.SmoothShading:THREE.FlatShading;if("normal"!=a.blendMode)switch(a.blendMode){case "add":b.blending=THREE.AdditiveBlending;break;case "subtract":b.blending=THREE.SubtractiveBlending;break;case "multiply":b.blending=THREE.MultiplyBlending;break;case "screen":b.blending=THREE.CustomBlending,b.blendSrc=THREE.OneFactor,b.blendDst=THREE.OneMinusSrcColorFactor,
b.blendEquation=THREE.AddEquation}for(var c=0;c<a.technique.length;c++){var d=a.technique[c];this.materialTechnique[d.kind]&&this.materialTechnique[d.kind].call(this,b,d,a)}this.materialTechnique.onComplete&&this.materialTechnique.onComplete.call(this,b,a);this.domain.materials=this.materials=this.materials||[];this.materials.push(this.objects["mat/"+a.name]=a.tag=b)};
...
THREE.SEA3D.prototype.getSkeletonAnimation=function(a,b){if(a.tag)return a.tag;for(var c=[],d=1E3/a.frameRate/1E3,e=0;e<a.sequence.length;e++){for(var f=a.sequence[e],h=f.start,g=h+f.count,k={name:f.name,fps:a.frameRate,length:d*(f.count-1),hierarchy:[]},l=a.numJoints,m=a.raw,q=0;q<l;q++){for(var r={parent:b.joint[q].parentIndex,keys:[]},s=r.keys,t=0,p=h;p<g;p++){var n=p*l*7+7*q;s.push({time:t,pos:[m[n],m[n+1],m[n+2]],rot:[m[n+3],m[n+4],m[n+5],m[n+6]],scl:[1,1,1]});t+=d}k.hierarchy[q]=r}h=THREE.AnimationClip.parseAnimation(k,
b.tag);h.loop=f.repeat;c.push(h)}return a.tag=c};
THREE.SEA3D.prototype.readVertexAnimation=function(a){for(var b={position:[]},c=[],d=[],e=0,f=a.frame.length;e<f;e++){var h=a.frame[e];b.position[e]=new THREE.Float32Attribute(new Float32Array(h.vertex),3);h.normal&&(b.normal=b.normal||[],b.normal[e]=new THREE.Float32Attribute(new Float32Array(h.normal),3));c[e]={name:e}}for(e=0;e<a.sequence.length;e++){f=a.sequence[e];h=[];for(e=0;e<f.count;e++)h[e]={name:f.start+e};h=THREE.AnimationClip.CreateFromMorphTargetSequence(f.name,h,a.frameRate);h.loop=
f.repeat;d.push(h)}a.tag={attribs:b,targets:c,animations:d}};THREE.SEA3D.prototype.readActions=function(a,b){for(var c=0;c<b.actions.length;c++){var d=b.actions[c];switch(d.kind){case SEA3D.Actions.SCRIPTS:this.domain.scripts=this.getJSMList(this.domain,d.scripts),this.config.runScripts&&this.domain.runJSMList(a)}}};
...
THREE.SEA3D.prototype.updateAnimationSet=function(a){var b=new THREE.Matrix4,c=new THREE.Matrix4,d=new THREE.Vector3,e=new THREE.Quaternion,f=new THREE.Vector3,h=new THREE.Vector3,g=new THREE.Quaternion,k=new THREE.Vector3;return function(a){var m=a.animation.animationSet,q=m.animations;if(!m.flip||q.length){for(var r=q[0].dataList,q=[],s=0;s<r.length;s++){var t=r[s],p=r[s].data,n=t.kind,t=p.length/t.blockLength;switch(n){case SEA3D.Animation.POSITION:case SEA3D.Animation.ROTATION:case SEA3D.Animation.SCALE:q.push({kind:n,
...
THREE.SEA3D.prototype.getSkeletonAnimationLegacy=function(a,b){var c=new THREE.Matrix4,d=new THREE.Matrix4,e=new THREE.Matrix4,f=new THREE.Matrix4;return function(a,b){if(a.tag)return a.tag;for(var k=[],l=1E3/a.frameRate/1E3,m=[1,1,1],q=0;q<a.sequence.length;q++){for(var r=a.sequence[q],s=r.start,t=s+r.count,p={name:r.name,fps:a.frameRate,length:l*(r.count-1),hierarchy:[]},n=a.numJoints,v=a.raw,w=0;w<n;w++){for(var y=b.joint[w],B={parent:y.parentIndex,keys:[]},C=B.keys,z=0,A=s;A<t;A++){var u=A*n*
7+7*w;d.makeRotationFromQuaternion(THREE.SEA3D.QUABUF.set(v[u+3],v[u+4],v[u+5],v[u+6]));d.setPosition(THREE.SEA3D.VECBUF.set(v[u],v[u+1],v[u+2]));-1<y.parentIndex?(c.elements=b.joint[y.parentIndex].inverseBindMatrix,f.getInverse(c),e.multiplyMatrices(f,d),this.flipMatrixBone(e),this.flipMatrixBone(f),f.getInverse(f),d.multiplyMatrices(f,e)):this.flipMatrixBone(d);var u=THREE.SEA3D.VECBUF.setFromMatrixPosition(d),x=THREE.SEA3D.QUABUF.setFromRotationMatrix(d);C.push({time:z,pos:[u.x,u.y,u.z],rot:[x.x,
x.y,x.z,x.w],scl:m});z+=l}p.hierarchy[w]=B}s=THREE.AnimationClip.parseAnimation(p,b.tag);s.loop=r.repeat;k.push(s)}return a.tag=k}}();THREE.SEA3D.prototype.readVertexAnimation=function(a){if(this.isLegacy(a))for(var b=0,c=a.frame.length;b<c;b++){var d=a.frame[b];this.flipZVec3(d.vertex);this.flipZVec3(d.normal)}this._readVertexAnimation(a)};
