var LoadorDrag = function(callback, isOld){
    ...
    this.drager.style.cssText = def+"position:absolute; top:100px; left:6px; width:50px; height:30px; border:1px dashed #ccc; pointer-events:auto; cursor:default;";
    this.loader.style.cssText = def+"position:absolute; top:100px; left:66px; width:50px; height:30px; pointer-events:none; border:1px solid #ccc; ";
    this.hide.style.cssText = "position:absolute; top:100px; left:66px; width:50px; padding-top:10px; height:30px; opacity:0; overflow:hidden; cursor:pointer; pointer-events:auto;";
