...
SEA3D.Stream.prototype.readUTF8=function(a){a=this.readBytes(a);return window.TextDecoder?(new window.TextDecoder).decode(a):String.fromCharCode.apply(void 0,new Uint16Array(new Uint8Array(a)))};SEA3D.Stream.prototype.readExt=function(){return this.readUTF8(4).replace(/\0/g,"")};SEA3D.Stream.prototype.readUTF8Tiny=function(){return this.readUTF8(this.readUByte())};SEA3D.Stream.prototype.readUTF8Short=function(){return this.readUTF8(this.readUShort())};SEA3D.Stream.prototype.readUTF8Long=function(){return this.readUTF8(this.readUInt())};
